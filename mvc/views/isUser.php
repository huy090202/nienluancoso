...
<head>
    ...
    <title>Phụ kiện Anker - User</title>
...
<body>
    <header id="header">
        <div class="row">
            <div class="d-flex align-items-center header">
                ...
                <div class="col-md-8">
                    <form class="head-form d-flex" method="post">
                        <input type="search" class="head-input form-control" placeholder="Search..."
                ...
                <div class="col-md-2 d-flex justify-content-end">
                    ...
                    <div class="head-cart d-flex justify-content-center align-items-center" title="Giỏ hàng">
                        <a href="giohang" class="head-cart__a">
    ...
    <main id="content" class="container d-flex">
        <div class="col-12">
            <?php 
            if(!empty($data['getUserById'])) {
                $user=$data['getUserById'];
                echo '
                    <div class="col-12 col-sm-8 col-md-9 in4-content">
                        <div class="in4-content__item active">
                            <div class="header_file">
                                <h5>Hồ sơ của tôi</h5>
                                <p>Quản lý thông tin hồ sơ để bảo mật tài khoản</p>
                            </div>
                            <div class="d-flex flex-column align-items-center avatar_file">
                                <div class="d-flex align-items-center justify-content-center avatar_icon">
                                    <i class="fa-regular fa-user"></i>
                                </div>
                                <label for="fileImg" class="choose_file">Chọn Ảnh</label>
                                ...
                                <div class="col-md-10">
                                    <form class="user-form" method="post">
                                        <div class="form-group row">
                                            <label for="user_name" class="col-sm-2 col-form-label text-nowrap">Họ và tên: </label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="user_name"
                                                    placeholder="Họ và tên" readonly  value="'.$user['user_name'].'" />
                                            </div>
                                           </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <label for="phone_number" class="col-sm-2 col-form-label text-nowrap">SDT: </label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="phone_number"
                                                    placeholder="Số điện thoại" readonly value="'.$user['phone_number'].'" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="phone_number" class="col-sm-2 col-form-label text-nowrap">Địa chỉ: </label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="user_address"
                                                    placeholder="Địa chỉ" readonly value="'.$user['user_address'].'" />
                                            </div>
                                        </div>
                                        <div class="row justify-content-center">
                                            <a href="/nienluancoso/nguoidung/updateUserById/'.$user['id_user'].'" class="btn btn-primary ml-2">Cập nhật thông tin</a>
                                        </div>
                                    </form>
                                </div>
                             </div>
