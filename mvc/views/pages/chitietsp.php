<div class="container">
    ...
    <div class="w-100 carousel main-slideshow2">
        ...
        <!-- <div class="carousel-cell">
            <div class="card" style="width: 100%; border: none">
                <img class="card-img-top" src="/nienluancoso/public/images/sanpham/sp9.jpg" alt="Card image cap" />
                <div class="card-body text-center">
                    <h5 class="card-title">
                        Sạc Anker 2 Cổng, 12w - [PowerPort 2 Lite, 2 x IQ port] -
                        A2129
                    </h5>
                    <p class="card-text" style="color: red">650,000 ₫</p>
                </div>
            </div>
        </div>
        <div class="carousel-cell">
            <div class="card" style="width: 100%; border: none">
                <img class="card-img-top" src="/nienluancoso/public/images/sanpham/sp11.jpg" alt="Card image cap" />
                <div class="card-body text-center">
                    <h5 class="card-title">
                        Sạc Anker 6 cổng, 60w [PowerPort 6, 60w] - A2123
                    </h5>
                    <p class="card-text" style="color: red">900,000 ₫</p>
                </div>
            </div>
        </div>
        <div class="carousel-cell">
            <div class="card" style="width: 100%; border: none">
                <img class="card-img-top" src="/nienluancoso/public/images/sanpham/sp12.jpg" alt="Card image cap" />
                <div class="card-body text-center">
                    <h5 class="card-title">
                        Sạc Anker PowerPort Elite 2, 24w - A2023
                    </h5>
                    <p class="card-text" style="color: red">600,000 ₫</p>
                </div>
            </div>
        </div>
        <div class="carousel-cell">
            <div class="card" style="width: 100%; border: none">
                <img class="card-img-top" src="/nienluancoso/public/images/sanpham/spm2.jpg" alt="Card image cap" />
                <div class="card-body text-center">
                    <h5 class="card-title">
                        Sạc Không Dây Anker Powerport Qi, 5w - A2511
                    </h5>
                    <p class="card-text" style="color: red">500,000 ₫</p>
                </div>
            </div>
        </div>
        <div class="carousel-cell">
            <div class="card" style="width: 100%; border: none">
                <img class="card-img-top" src="/nienluancoso/public/images/sanpham/sp4.jpg" alt="Card image cap" />
                <div class="card-body text-center">
                    <h5 class="card-title">
                        Pin dự phòng Anker PowerCore 13000 - A1215
                    </h5>
                    <p class="card-text" style="color: red">1,000,000 ₫</p>
                </div>
            </div>
        </div> -->
    </div>
